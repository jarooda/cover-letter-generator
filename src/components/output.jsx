  ...
  return (
      <div className="col-6">
        <div className="text-justify" id="copied">
          ...
          <p>I’m submitting my application for the {input.appliedPosition} position at {input.companyName}. I am a recent graduate of Hacktiv8 Fullstack Javascript Bootcamp, having completed courses in frontend, backend and databases with score 101.41 of 105. I have a strong aptitude for problem solving and fullstack developing a web with specialty in the frontend.</p>
